...
import { getAdminProduct, updateAdminProduct, getAdminCategories } from '../../api/adminApi';
  ...
  const loadData = async () => {
    try {
      ...
      setFormData({
        ...
        rentingStock: product.rentingStock || '',
        size: product.size || '',
        color: product.color || '',
        condition: product.condition || 'New',
        sellingPrice: product.sellingPrice || product.sellPrice || '',
        status: product.status || 'In Stock',
        allowRental: product.allowRental || false,
        rentalPrice: product.rentalPrice || product.rentPrice || '',
